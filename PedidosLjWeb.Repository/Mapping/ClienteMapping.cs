...
namespace PedidosLjWeb.Repository.Mapping
{
    ...
    public class ClienteMapping : IEntityTypeConfiguration<Cliente>
    {
        public void Configure(EntityTypeBuilder<Cliente> builder)
        {
            ...
            builder.Property(x => x.Complemento).HasMaxLength(1000);
            ...
            builder.HasMany(x => x.Pedidos).WithOne(x=> x.Cliente).HasForeignKey(x=>x.ClienteId).OnDelete(DeleteBehavior.Cascade);
